...
public class DiscoveryModel implements TextContract {
    @Override
    public void requestText(String type, long time, final TextFragmentView textFragmentView) {
        ...
        constans.requestDiscovery(type, 1, HTTP.APP_NAME, time, HTTP.TOKEN).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<HotBean>() {
                    ...
                    public void onNext(@NonNull HotBean hotBean) {
                        textFragmentView.showLoadSuccessView(hotBean);
                    }
