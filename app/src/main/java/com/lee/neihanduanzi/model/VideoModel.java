...
public class VideoModel implements TextContract {
    @Override
    public void requestText(String type,long time, final TextFragmentView textFragmentView) {
        ...
        constans.requestVideo(type,1,HTTP.APP_NAME,time,HTTP.TOKEN).observeOn(AndroidSchedulers.mainThread()).subscribeOn(Schedulers.io())
                .subscribe(new Observer<VideoBean>() {
                    ...
                    @Override
                    public void onNext(@NonNull VideoBean object) {
