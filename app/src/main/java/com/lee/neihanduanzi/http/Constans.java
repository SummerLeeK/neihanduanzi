...
public interface Constans {
    ...
    @GET("/{api}/")
    Observable<HotBean> requestDiscovery(@Path("api") String api, @Query("is_json") int is_json, @Query("app_name") String app_name, @Query("min_time") long max_time, @Query("csrfmiddlewaretoken") String token);

    /**
     *  发现接口请求回来的某一个item项的详情接口
     * @param api
     * @param id
     * @param is_json
     * @param app_name
    ...
    @GET("/{api}/{id}/")
    Observable<DiscoveryBean> requestSomeItem(@Path("api") String api, @Path("id") int id, @Query("is_json") int is_json, @Query("app_name") String app_name, @Query("min_time") long max_time, @Query("csrfmiddlewaretoken") String token);
    ...
    @GET("/{api}/")
    Observable<HotBean> requestGodComment(@Path("api") String api, @Query("is_json") int is_json, @Query("app_name") String app_name, @Query("min_time") long max_time, @Query("csrfmiddlewaretoken") String token);
